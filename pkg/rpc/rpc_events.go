...
func (r *RPCServer) Subscribe(ctx context.Context, subscriber string, query string, outCapacity ...int) (out <-chan coretypes.ResultEvent, err error) {
	...
	// TODO: Implement subscription logic using r.adapter.EventBus
	// Example structure (needs actual implementation):
	// q, err := cmtquery.New(query)
	// if err != nil {
	// 	return nil, fmt.Errorf("failed to parse query: %w", err)
	// }
	// sub, err := r.adapter.EventBus.Subscribe(ctx, subscriber, q, outCapacity...)
	// if err != nil {
...
func (r *RPCServer) Unsubscribe(ctx context.Context, subscriber string, query string) error {
	...
	// TODO: Implement unsubscription logic using r.adapter.EventBus
	// Example structure:
	// q, err := cmtquery.New(query)
	// if err != nil {
	// 	return fmt.Errorf("failed to parse query: %w", err)
	// }
	// return r.adapter.EventBus.Unsubscribe(ctx, subscriber, q)
...
func (r *RPCServer) UnsubscribeAll(ctx context.Context, subscriber string) error {
	...
	// TODO: Implement unsubscribe all logic using r.adapter.EventBus
	// return r.adapter.EventBus.UnsubscribeAll(ctx, subscriber)
